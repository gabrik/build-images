...
lxc exec build -- bash -c "eval \$(opam env) && OPAMSOLVERTIMEOUT=240 opam pin add zenoh-tx-inet https://github.com/atolab/zenoh.git#0.3.0 -y"
lxc exec build -- bash -c "eval \$(opam env) && OPAMSOLVERTIMEOUT=240 opam pin add zenoh-router https://github.com/atolab/zenoh.git#0.3.0 -y"
