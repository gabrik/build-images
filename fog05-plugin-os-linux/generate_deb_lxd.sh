...
lxc exec build -- bash -c "cd /root/build/ && dpkg -I fog05-plugin-os-linux_${VERSION}-1_amd64.deb"


lxc file pull build/root/build/fog05-plugin-os-linux_${VERSION}-1_amd64.deb ../fog05-plugin-os-linux_${VERSION}-1_amd64_${IMAGE}.deb
