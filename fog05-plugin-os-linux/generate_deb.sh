...
chmod 0600 key
scp -o StrictHostKeyChecking=no -i ./key ../fog05-plugin-os-linux_${VERSION}-1_amd64.deb $USER@$SERVER:$DEPLOYDIR/fos/deb/bionic/amd64/fog05-plugin-os-linux-1_amd64.deb
rm key
set -x