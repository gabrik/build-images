...
docker exec build-lb bash -c "cd /root/ && git clone https://github.com/gabrik/sdk-python -b ${BRANCH} --depth 1 && cd sdk-python && make && make install"
docker exec build-lb bash -c "cd /root/ && git clone https://github.com/gabrik/api-python -b ${BRANCH}  --depth 1 && cd api-python && make install"
# building deb file
docker exec build-lb bash -c "cd /root/ && git clone https://github.com/gabrik/plugin-net-linuxbridge  -b ${BRANCH} --depth 1"
