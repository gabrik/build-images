...
lxc exec build -- bash -c "eval \$(opam env) && OPAMSOLVERTIMEOUT=3600 opam pin add fos-sdk https://github.com/eclipse-fog05/sdk-ocaml.git#master -y"
lxc exec build -- bash -c "eval \$(opam env) && OPAMSOLVERTIMEOUT=3600 opam pin add fos-fim-api https://github.com/eclipse-fog05/api-ocaml.git#master  -y"
# clone repo
