...
CONF=/etc/fos/plugins/plugin-fdu-native/native_plugin.json
...
/etc/fos/plugins/plugin-fdu-native/native_plugin /etc/fos/plugins/plugin-fdu-native/native_plugin.json